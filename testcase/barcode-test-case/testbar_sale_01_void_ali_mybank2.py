...
class TestPayVoidCheck(unittest.TestCase):
    ...
    def test_b_BarVoid(self):
        ''' alipay mybank2条码支付撤销'''
        voidload = "{\"merOrderId\":\"" + self.mer_orderId + "\",\"mid\":\"898310077779999\", \
