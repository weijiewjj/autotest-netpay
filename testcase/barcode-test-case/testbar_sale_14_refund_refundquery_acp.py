...
class TestPayRefundQuery(unittest.TestCase):
    ...
    def test_b_Refund(self):
        '''银联云闪付ACP渠道条码支付退货和退货查询'''
        now_time = datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')
        refundload = "{\"merOrderId\":\""+self.mer_orderId+"\",\"mid\":\"898310148160568\", \
    ...
    def test_c_RefundQuery(self):
        ...
        refundqueryload = "{\"merOrderId\":\""+self.test_b_Refund()+"\",\"mid\":\"898310148160568\", \
